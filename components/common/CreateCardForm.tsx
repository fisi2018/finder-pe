...
import { ErrorCreateCard, FormTypeCreateCard, HandlerSubmit } from "../../models/types/formTypes";
...
export default function CreateCardForm():ReactElement{
    const {handleChange,setForm,form}=useForm(formInit) as HookCreateCard ;
    const [loading,setLoading]=useState<boolean>(false);
    const handleSubmit:HandlerSubmit=async(e)=>{
        e.preventDefault();
        const {title,description,address}:ErrorCreateCard=validateFormCreatePlace(form);
